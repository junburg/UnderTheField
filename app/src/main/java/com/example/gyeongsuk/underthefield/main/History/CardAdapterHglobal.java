...
public class CardAdapterHglobal<T> extends RecyclerView.Adapter<CardAdapterHglobal.ViewHolder> {
    ...
    public CardAdapterHglobal( List<T> datas, int itemLayout, Context context) {
        this.datas = datas;
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        if(data instanceof CardDataHglobal) {

            holder.hCardUserName.setText(((CardDataHglobal) data).gethGlobalUserName());
            holder.hCardArtistName.setText(((CardDataHglobal) data).gethGlobalArtistName());
            holder.hCardTitleName.setText(((CardDataHglobal) data).gethGlobalTitleName());
            final String goWeb = ((CardDataHglobal) data).gethGlobalScUrl();
